...
public class agregarPacienteP2 extends javax.swing.JFrame {
   ...
   Paciente paciente = new Paciente();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        agregarPacienteP1 updatePaciente = new agregarPacienteP1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(agregarPacienteP2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agregarPacienteP2().setVisible(true);
            }
        });
    }
